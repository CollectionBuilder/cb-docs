...
The "_data/config-search.csv" enables GH and CSV users to select which metadata fields they would like indexed for the collection object search powered by [Lunr.js](https://lunrjs.com/). 
