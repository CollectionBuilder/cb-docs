...
If you want to use Rake tasks to batch process PDF and image files for **CollectionBuilder-CSV** and **-SA**, this software is required! (Note: ***CollectionBuilder-SA is now deprecated!*** We strongly recommend using -CSV instead.)
...
We use the software listed below to batch process digital files for use in CollectionBuilder-CSV and -SA projects. 
...
CSV and SA templates include a [Rake](https://github.com/ruby/rake) task that automates creating derivative images for PDF and image items.
