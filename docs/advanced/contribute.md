...
Outside contributors are welcome and encouraged to help develop [CollectionBuilder](https://github.com/CollectionBuilder) templates and documentation on GitHub.
...
- Most development happens in our main repository [CollectionBuilder-CSV](https://github.com/CollectionBuilder/collectionbuilder-csv). Other templates and Built Ons pull from the CB-CSV base.
...
- You can more informally ask questions and share ideas in the main [CollectionBuilder Discussions forum](https://github.com/orgs/CollectionBuilder/discussions).
...
- New features should be progressive--adding features, while maintaining backwards compatibility with existing data setups. If possible, sensible defaults should be set in Liquid and JS, so that projects lacking updated config variables will still function.
